<?php
namespace TopBrands\BrandsCollection\Setup\Patch\Data;
...
class BrandsCollection implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $cmsBlockData = [
            'title' => 'Top Brands Slider Block',
            'identifier' => 'Top Brands Slider Block',
            'content' => '{{block class="Magento\Framework\View\Element\Template"
            template="TopBrands_BrandsCollection::topbrands.phtml"}}',
            'is_active' => 1,
            'stores' => [0],
            'sort_order' => 60
        ];
